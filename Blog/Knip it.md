...
There is a new library from the same author called [unbarrelify](https://github.com/webpro-nl/unbarrelify). It is a codemod that removes redundant barrel files.
